...
const PrivacyPolicy = () => (
  <Container>
    ...
    <ol>
      <li>
        Administratorem danych jest {COMPANY_NAME} z siedzibą w Poznaniu, ul.
        Ostrówek 10/11, NIP: {NIP}, REGON: {REGON}. Ochrona danych odbywa się
      ...
      <li>
        Dla interpretacji terminów stosuje się słowniczek Regulaminu lub tak jak
        zostało to opisane w Polityce Prywatności (jeżeli wynika to bezpośrednio
        z opisu).
      </li>
      <li>
    ...
    <ol>
      <li>
        Usługodawca jest administratorem danych swoich klientów. Oznacza to, że
        jeśli posiadasz Konto na naszej stronie, to przetwarzamy Twoje dane jak:
        imię, nazwisko, adres e-mail, numer telefonu, stanowisko, miejsce pracy,
        adres IP.
      </li>
      <li>
        Usługodawca jest także administratorem osób, które pobrały zamieszczone
        na stronie poradniki lub wypełniły jeden z formularzy.
      </li>
      <li>
        ...
        <ul>
          ...
          <li>w zakresie i celu zgodnym ze zgodą wyrażoną przez Ciebie</li>
        </ul>
      </li>
      <li>
    ...
    <ol>
      <li>
        Witryna robson.com.pl używa cookies. Są to niewielkie pliki tekstowe
        ...
        odwiedzonych witryn.<br />Gromadzone informacje dotyczą adresu IP, typu
      ...
      <li>
        ...
        stronie. <br />Cookies identyfikuje użytkownika, co pozwala na
        dopasowanie treści witryny, z której korzysta, do jego potrzeb.
        Zapamiętując jego preferencje, umożliwia odpowiednie dopasowanie
        skierowanych do niego reklam. Stosujemy pliki cookies, aby zagwarantować
        najwyższy standard wygody naszego serwisu, a zebrane dane są
        wykorzystywane jedynie wewnątrz firmy {COMPANY_NAME} w celu
        optymalizacji działań.
      </li>
      <li>
        Na naszej witrynie wykorzystujemy pliki cookies, umożliwiające zbieranie
      ...
      <li>
        ...
        na to zgodę. Powyższe dane zachowujemy i wykorzystujemy tylko do potrzeb
