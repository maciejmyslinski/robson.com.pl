...
export const pricingDetails = [
  {
    ...
    description: (
      <div>
        <p>Do kosztów naprawy zostanie doliczony koszt części zamiennych.</p>
        <p>
          Ich ceny będą zgodne z cennikiem detalicznym producenta. Jeżeli taki
          nie występuje, będą one zgodne z detaliczną ceną rynkową powiększoną o
          koszt zakupu. W wypadku braku na rynku polskim oryginalnych części
          zamiennych lub zamienników, wycena ich dorobienia będzie dokonywana
          indywidualnie.
        </p>
      </div>
    ),
  },
  {
    ...
    description: (
      <div>
        <p>
          Na życzenie klienta, dokładny koszt części zamiennych oraz
          przewidywany czas naprawy może zostać podany przed przystąpieniem do
          naprawy, ale po zrobieniu przeglądu lub oględzin przez serwisanta.
        </p>
        <p>
          W wypadku odstąpienia przez klienta od naprawy, po zrobieniu wyceny
          części zamiennych i szacowanego kosztu naprawy, zostanie pobrana
          opłata za przegląd danego typu bramy lub za oględziny zgodnie ze
          stawkami z tego cennika.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    description: (
      <div>
        ...
        <p>
          Jeżeli klient nie zdecyduje się na przegląd, nie wykonujemy
          szczegółowych wycen naprawy bram i automatyki.
        </p>
        <p>
          Ceny mogą być indywidualnie przez Państwa negocjowane tylko przed
          wykonaniem usługi. Zapraszamy do negocjacji.
        </p>
      </div>
    ),
  },
